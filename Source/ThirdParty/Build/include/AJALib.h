...
namespace AJA
{
	...
	*****************************************************************************/
	struct AJA_API IAJAAutoDectectCallbackInterface 
	{
		IAJAAutoDectectCallbackInterface();
		virtual ~IAJAAutoDectectCallbackInterface();
	...
	*****************************************************************************/
	...
	public:
		bool Initialize(IAJAAutoDectectCallbackInterface* InCallbackInterface);
		void Uninitialize();
